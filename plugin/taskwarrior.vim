...
let g:task_interactive_command      = ['annotate', 'denotate', 'exeucte', 'duplicate', 'append', 'prepend', 'stop', 'delete', 'done', 'undo', 'config', 'edit', 'start', 'sync', 'synchronize', 'add', 'modify', 'import', 'colors', 'color', 'logo']
